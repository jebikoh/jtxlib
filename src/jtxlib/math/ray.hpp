...
namespace jtx {
    ...
    public:
        ...
        JTX_HOSTDEV JTX_INLINE bool operator==(const RayDifferential &other) const {
        ...
        JTX_HOSTDEV JTX_INLINE bool equals(const RayDifferential &other, T epsilon) const {
        ...
        JTX_HOSTDEV JTX_INLINE void scale(T s) {
